...
const forgotPassword = async (req, res, next) => {
  ...
  (or someone else) has requested 
  the reset of a password. Please 
...
exports.forgotPassword = asyncHandler(forgotPassword)
...
exports.updateDetails = asyncHandler(updateDetails)
...
exports.logout = asyncHandler(logout)
